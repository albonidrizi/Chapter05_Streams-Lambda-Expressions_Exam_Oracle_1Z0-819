package S03_streams_basic.exercises;
...
public class BasicStreamsExercise06 {
    ...
    public String formatProductList(List<Product> products) {
        // TODO: Convert each of the products to a string (using Ushtrime.Ushtrime.S01_lambda_expressions.Product.toString()) and collect the results in a string.
